...
#       tesla1 = 3
#       tesla2 = 4
#       x.extend([tesla1, tesla2])
#       print(Fore.LIGHTCYAN_EX + "Total Tesla GPU devices",":"+ Style.RESET_ALL ,x)
...
def select_n_gpu():       
      ...
      #       low = answer.lower()
      #       if answer == '' or not low in ['yes','no']: 
      ...
      # Ask the user the quantity of gpu the user needs 
      ...
      for a in range(quest):
            # Check if user selection is greater then the number of available GPU on the system, and take the current available GPU list for him
